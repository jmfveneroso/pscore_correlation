...
\authornote{
João Mateus de Freitas Veneroso (jmfveneroso@gmail.com), Marlon Dias (msdias@dcc.ufmg.br), Berthier Ribeiro-Neto (berthier@dcc.ufmg.br) and Nivio Ziviani (nivio@dcc.ufmg.br), Department of Computer Science, Universidade Federal de Minas Gerais, Av. Pres. Antônio Carlos, 6627 - Pampulha, Belo Horizonte - MG, Brazil, 31270-901, Phone: +55 31 3499-5860; Edmundo de Souza e Silva (edmundo@land.ufrj.br), Department of Systems Engineering and Computer Science, COPPE, Universidade Federal do Rio de Janeiro, Centro de Tecnologia 2 (CT 2), Rua Moniz Aragão Nº 360, Bloco 1, 
Ilha do Fundão - Cidade Universitária, Rio de Janeiro - RJ, Brazil, 21941-594, Phone: +55 21 3622-3477.

Correspondence concerning this article should be addressed to João Mateus de Freitas Veneroso, Department of Computer Science, Universidade Federal de Minas Gerais, Av. Pres. Antônio Carlos, 6627 - Pampulha, Belo Horizonte - MG, Brazil, 31270-901.

Contact: jmfveneroso@gmail.com
...
\begin{figure}[h!]
  \begin{center}
    ...
    \begin{tikzpicture}
      ...
      \end{axis}
    \end{tikzpicture}
    \caption{Normalized P-score VS Normalized H-index.}
    \label{fig:pscore_hindex_ranks}
  \end{center}
\end{figure}
