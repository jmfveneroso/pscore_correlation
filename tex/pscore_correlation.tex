...
\begin{table}[h!]
  ...
  9  & WCNC         &  FOCS          &  ACSAC       \\
  10 & LCPC         &  INTERSPEECH   &  VTC         \\
  11 & ISQED        &  ICCAD         &  GECCO       \\
  12 & ISER         &  IJCAI         &  ICWS        \\
  13 & WACV         &  SODA          &  ESOP        \\
  14 & ITS          &  INFOCOM       &  AAMAS       \\
  15 & ICWSM        &  ICML          &  PKC         \\
  16 & AIED         &  ICIP          &  ISMIR       \\
  17 & GIS          &  SIGMOD        &  ICIS        \\
  18 & HRI          &  ICSE          &  ECRTS       \\
  ...
  20 & HOTNETS      &  ICCV          &  GI          \\
  21 & SECON        &  ICDE          &  PIMRC       \\
  22 & HUMANOIDS    &  ACL           &  SACMAT      \\
  23 & ICCCN        &  ECCV          &  PG          \\
  24 & DGO          &  ISCA          &  DIS         \\
  25 & WAFR         &  KDD           &  P2P         \\
  26 & ISBI         &  SIGCOMM       &  GRID        \\
  27 & SMC          &  SC            &  MDM         \\
  28 & IVA          &  WWW           &  AINA        \\
  29 & CICC         &  ICDCS         &  ICSOC       \\
  30 & FSTTCS       &  DATE          &  ASYNC       \\
  \bottomrule
  \end{tabular}
  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addplot[blue, only marks, mark size=0.75pt] 
        table[x=column 1,y=column 2,col sep=comma] {data/hindex_citations.csv}; 
...
\begin{table}[h!]
  ...
  \midrule
  P-score     & H-index           & 0.5312 & 0.7062 \\
  P-score     & Total Citations   & 0.5016 & 0.6737 \\
  P-score     & Citations/Paper   & 0.3882 & 0.5541 \\
  N. P-score  & N. H-index        & 0.4742 & 0.6508 \\
  H-index     & Total Citations   & 0.6176 & 0.7657 \\
  \bottomrule
  \end{tabular}
