...
what is also observed in P-score. In fact, the number of citations received by a conference does
not seem to be widely correlated to the number of publications in that conference. That is, only
because a conference holds a larger number of publications, this does not mean that it will also have
a larger P-score, H-index or Total Number of Citations. 
