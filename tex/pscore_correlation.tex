...
and Citations per Paper in CS conference rankings. In particular, we wanted to estimate the degree of 
correlation between P-scores and citation based indices, attenting to where they differ.

The data set consists of 794
