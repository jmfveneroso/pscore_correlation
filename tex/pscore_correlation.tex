...
\centering
  ...
  \centering
    \begin{tikzpicture} [scale=0.6]
      \begin{axis}[
          ...
          grid style={dashed,gray!30}, % Set the style
          xlabel=H-index Ranks,
          ylabel=Citations Per Publication Ranks,
          xmin=-100,
          ymin=-100,
          xmax=900,
          ymax=900
  ...
  \end{subfigure}
  \caption{
  Scatter plots comparing the rankings produced with P-scores, H-index, Total Citations 
